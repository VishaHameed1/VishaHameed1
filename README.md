...
|---------|------------|-------------|
| [**AiImageDetector**](https://github.com/VishaHameed1/AiImageDetector) | C#, ML.NET | 88.67% accuracy - Distinguishing AI-generated images |
| [**Facial Emotion Recognition**](https://github.com/VishaHameed1/hexsoftware_Emotion_Detection_using_AI) | Python, OpenCV | Real-time emotion detection from faces |
| [**Age & Gender Detection**](https://github.com/VishaHameed1/hexsoftware_Gender_Prediction_Age_Estimation) | Python, OpenCV | Predict age & gender from images |
...
| [**AI Chatbot**](https://github.com/VishaHameed1/HexSoftwares_AI_Chatbot) | Gemini 2.5, Python | Intelligent conversational agent |
| [**PropTrack-MERN**](https://github.com/VishaHameed1/PropTrack-MERN) | MERN Stack | Property tracking platform |
| [**Smart-Recipe-Assistant**](https://github.com/VishaHameed1/Smart-Recipe-Assistant) | Java, Gemini AI | Recipe recommendations with AI |
...
- 🔧 Upgraded [Age & Gender Detection](https://github.com/VishaHameed1/hexsoftware_Gender_Prediction_Age_Estimation)
- 🎯 [AiImageDetector](https://github.com/VishaHameed1/AiImageDetector) - 88.67% accuracy achieved
- 🛡️ Enhanced security in [PropTrack-MERN](https://github.com/VishaHameed1/PropTrack-MERN)
...
<p align="center">
  <b>🌟 Star my repos to support my work! 🌟</b>
</p>

<p align="center">
  <img src="https://readme-typing-svg.demolab.com/?lines=Thanks+for+visiting!;Have+a+great+day!;Keep+coding!&center=true&width=400&height=30&size=18">
</p>
